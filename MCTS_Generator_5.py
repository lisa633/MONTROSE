...
#     gen_target = copy.deepcopy(source_domain)
    ...
    for i,d_ID in enumerate(source_domain.data_ID[1650:1800]):
...
#     all_gen_target.dataclear()
    ...
    print(event_dir)
    if os.path.exists(f"../../autodl-tmp/data/pheme-rnr-dataset/qwen_gen_from_source/5"):
        gen_target.Caches_Data(event_dir)
    else:
        os.mkdir(f"../../autodl-tmp/data/pheme-rnr-dataset/qwen_gen_from_source/5")
        gen_target.Caches_Data(event_dir)
