...
from Data.BiGCN_Dataloader import BiGCNTwitterSet, FastBiGCNDataset, MetaMCMCDataset, load_data_all, \
    load_data_twitter15, load_data_twitter16
...
class BiGCNTrainer(RumorBaseTrainer):
    ...
    def fit(self, model: TwitterTransformer, train_set, dev_eval=None, test_eval=None, batch_size=5,
        ...
        optim.zero_grad()
        loss_list = []
        model.load_model("./indomain/twitter16/BiGCN_twitter16_0.917.pkl")
...
class MetaBiGCNTrainer(BiGCNTrainer, MetaLearningFramework):
    ...
    def meta_learning(self, model: TwitterTransformer, train_set, meta_dev,
        ...
        loss_lists = []
        train_step = 0
        # model.load_model("./indomain/twitter16/BiGCN_twitter16_0.882.pkl")
        model.load_model("./indomain/twitter16/BiGCN_twitter16_0.872.pkl")
...
if __name__ == '__main__':
    ...
    # data_dir = r"/data/run01/scz3924/hezj/MetaGenerator/pheme-rnr-dataset/"
    ...
    event = os.path.join(data_dir, "twitter16")
    tr, _, dev, meta_dev, te = load_data_twitter16(
        event, 0, unlabeled_ratio=-1
    )

    root_dir = "indomain"
    test_event_name = "twitter16"
    ...
    trainer = MCMCBiGCNTrainer(log_dir, None, model_rename=True, beam_K=3, batch_dir=f"./{root_dir}/aug_dir2")
    # trainer.fit(model, tr, dev_eval, te_eval, batch_size=32, grad_accum_cnt=1, learning_rate=2e-5,valid_every=1,
    #             max_epochs=20,
    ...
    #                       max_epochs=10, learning_rate=2e-5, model_lr=2e-5,
