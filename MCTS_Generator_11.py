...
#     gen_target = copy.deepcopy(source_domain)
    ...
    for i,d_ID in enumerate(source_domain.data_ID[3300:]):
...
#         print("parent:",parent_lists)
    ...
    event_dir = os.path.join(data_dir1,"qwen_gen_from_source","11",test_event_name)
    print(event_dir)
    gen_target.Caches_Data(event_dir)
    
    event_dir1 = os.path.join(data_dir1,"qwen_gen_from_source_all","11",test_event_name)
    print(event_dir1)
